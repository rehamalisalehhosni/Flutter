...
public interface ApiHelper {
    ...
    Single<LoginResponse> doServerLoginApiCall(LoginRequestt.ServerLoginRequestt request);

    Single<LoginResponse> getServerCustomers(LoginRequest.ServerLoginRequest request);
