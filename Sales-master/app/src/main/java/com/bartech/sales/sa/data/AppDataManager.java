...
package com.bartech.sales.sa.data;
...
import com.bartech.sales.sa.data.network.model.LogoutResponse;
...
public class AppDataManager implements DataManager {
    ...
    @Override
    public Single<LoginResponse> doServerLoginApiCall(LoginRequestt.ServerLoginRequestt
                                                              request) {
        return mApiHelper.doServerLoginApiCall(request);
    }

    @Override
    public Single<LoginResponse> getServerCustomers(LoginRequest.ServerLoginRequest request) {
        return mApiHelper.getServerCustomers(request);    }
