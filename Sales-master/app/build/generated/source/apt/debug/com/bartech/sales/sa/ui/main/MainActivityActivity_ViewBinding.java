...
public class MainActivityActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public MainActivityActivity_ViewBinding(MainActivityActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public MainActivityActivity_ViewBinding(MainActivityActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MainActivityActivity target = this.target;
