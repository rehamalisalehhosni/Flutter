...
public class CustomerActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public CustomerActivity_ViewBinding(CustomerActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public CustomerActivity_ViewBinding(final CustomerActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    CustomerActivity target = this.target;
